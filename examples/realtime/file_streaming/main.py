...
"""
Stream an audio file to the SpeechCortex realtime transcription API.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Stream a file for transcription")
    parser.add_argument("file", help="Path to the audio file (16-bit PCM WAV)")
    parser.add_argument("--interim-results", action="store_true", default=True)
    parser.add_argument(
        "--utterance-end-ms",
        type=int,
        default=1000,
